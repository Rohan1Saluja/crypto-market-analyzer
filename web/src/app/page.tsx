  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto w-full max-w-[1480px] px-4 pb-10 pt-8 sm:px-6 lg:px-8 lg:pt-10">
        <section className="instrument-enter relative overflow-hidden pb-8 pt-2">
          <div className="max-w-4xl">
            <div className="mb-5 flex flex-wrap items-center gap-3">
              <span className="data-label">Calyrn / Markets / Live</span>
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-white/[0.07] bg-white/[0.022] px-2.5 py-1 font-mono text-[9px] uppercase tracking-[0.08em] text-muted-foreground">
                <Activity className="size-3 text-[var(--calyrn-ice)]" />
            ...
            <h1 className="max-w-4xl font-heading text-[clamp(2.65rem,7vw,6.4rem)] font-medium leading-[0.9] tracking-[-0.065em] text-foreground">
              Signal,
              <span className="block bg-[linear-gradient(90deg,var(--foreground)_0%,var(--calyrn-ice)_42%,var(--calyrn-jade)_76%,var(--calyrn-amber)_112%)] bg-clip-text text-transparent">
                in context.
              </span>
            </h1>
            ...
            <div className="mt-6 flex max-w-3xl flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <p className="max-w-xl text-sm leading-6 text-muted-foreground sm:text-[15px]">
                Personal crypto intelligence for research today, and the
                exposure, risk, and portfolio signals that matter next.
              </p>
        ...
        <section className="calyrn-panel calyrn-edge instrument-enter-delayed rounded-3xl">
          <div className="flex flex-col gap-4 border-b border-white/[0.06] px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div>
              <div className="data-label">Market context</div>
            ...
            <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
              <span>Calyrn market layer</span>
              <ArrowUpRight className="size-3.5 text-[var(--calyrn-ice)]" />
            </div>
          </div>
        ...
        <footer className="mt-8 flex flex-col gap-2 border-t border-white/[0.06] pt-4 font-mono text-[9px] uppercase tracking-[0.08em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <span>Calyrn / Signal, in context.</span>
          <span>
            Market data by{" "}
            <a
